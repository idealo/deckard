...
- 1.0.x -> supports Spring Kafka 2.2.x and is compatible with Spring Boot 2.1.x
- 0.x.x (LEGACY) -> supports Spring Kafka 2.1.x and is compatible with Spring Boot 2.0.x
